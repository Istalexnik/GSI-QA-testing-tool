    ...
    Class Environment
        ...
        Public Shared Function CreateEnvironments() As List(Of Environment)
            Dim list As List(Of Environment) = New List(Of Environment) From {
                ...
                New Environment("PR STAGING", "https://staging-app-vos72000000.geosolinc.com/vosnet/default.aspx", "00780", "Puerto Rico", "PR", "Publix", "Toyota", "GSISA0", "GeoIAGUSSol22*@"),
                New Environment("DC UI UAT", "https://uat-app-vos11000000-ui.geosolinc.com/vosnet/default.aspx", "20010", "District of Columbia", "DC", "SERDINO INC", "Toyota", "GSISA0", "GeoIAGUSSol22*@"),
                ...
                New Environment("NE UAT", "https://uat-app-vos31000000.geosolinc.com/vosnet/default.aspx", "68104", "Nebraska", "NE", "GSITAXMCINEXP3", "Toyota", "GSISA0", "GeoIAGUSSol22*@"),
