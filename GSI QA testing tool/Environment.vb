    ...
    Class Environment
        ...
        Public Shared Function CreateEnvironments() As List(Of Environment)
            Dim list As List(Of Environment) = New List(Of Environment) From {
                ...
                New Environment("NE UAT", "https://uat-app-vos31000000.geosolinc.com/vosnet/default.aspx", "68104", "Nebraska", "NE", "AIR CONDITIONING UTILITIES", "Toyota", "GSISA0", "GeoIAGUSSol22*@"),
                ...
                New Environment("LA UAT", "https://uat-app-vos22000000.geosolinc.com/vosnet/default.aspx", "70803", "Louisiana", "LA", "CATAHOULA BANK", "Toyota", "GSISA0", "GeoIAGUSSol22*@"),
                ...
                New Environment("TN UAT", "https://uat-app-vos47000000.geosolinc.com/vosnet/default.aspx", "37243", "Tennessee", "TN", "PUBLIX SUPER MARKETS INC", "Toyota", "GSISA0", "GeoIAGUSSol22*@"),
                ...
                New Environment("GU UAT", "https://uat-app-vos66000000.geosolinc.com/vosnet/default.aspx", "86438", "Guam", "GU", "Publix", "Toyota", "GSISA0", "GeoIAGUSSol22*@"),
                ...
                New Environment("GU STAGING", "https://staging-app-vos66000000.geosolinc.com/vosnet/default.aspx", "86438", "Guam", "GU", "Publix", "Toyota", "GSISA0", "GeoIAGUSSol22*@"),
